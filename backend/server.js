...
const stockTransactionRoutes = require('./routes/invetory/stockTransactionRoutes');
const assetRequestRoutes = require('./routes/invetory/assetRequestRoutes');
...
app.use('/api/inventory/requests', assetRequestRoutes);
